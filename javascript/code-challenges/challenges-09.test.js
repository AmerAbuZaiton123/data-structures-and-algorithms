...
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
Write a function named getCourseKeys that takes in the courseInfo object and returns an array containing the keys
...
const checkValues = (obj, value) => {
  let checkingArr = Object.values(obj).map(objValue => {
    return objValue === value ? true : false;
  });
  return checkingArr.includes(true);
};
...
const hasChildrenValues = (arr, character) => {
  return arr.map(obj => {
    return (Object.values(obj).includes(character)) && Object.keys(obj).includes('children');
  }).includes(true) ? true : false;
};

/* ------------------------------------------------------------------------------------------------
CHALLENGE 7 - Stretch Goal
Write a function named hasChildrenEntries that is similar to your hasChildrenValues function from challenge 4, but uses the data's
entries instead of its values.
